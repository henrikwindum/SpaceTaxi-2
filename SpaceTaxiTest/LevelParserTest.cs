...
namespace LevelParserTesting {
    [TestFixture]
    public class LevelParserTesting {
        [SetUp]
        public void SetUp() {
        ...
        /// <summary>
        ///     Tests if the dictionary of short-n-sweet.txt contains the
        ///     right characters and strings in the right order
        /// </summary>
        [Test]
        public void ShortNSweetDictionaryTest() {
            for (var i = 0; i < shortnsweetDict.Count; i++) {
                Assert.AreEqual(shortnsweetDict.ElementAt(i), 
                    readShortNSweet.BoardDict.ElementAt(i));
            }
        }
        ...
        /// <summary>
        ///     Tests if the dictionary of the-beach.txt contains
        ///     the right characters and strings in the right order
        /// </summary>
        [Test]
        public void TheBeachDictionaryTest() {
            for (var i = 0; i < thebeachDict.Count; i++) {
                Assert.AreEqual(thebeachDict.ElementAt(i), 
                    readTheBeach.BoardDict.ElementAt(i));
            }
        }
    }
}