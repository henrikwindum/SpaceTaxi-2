    ...
    public class Tests {
        ...
        public void ShortNSweetDictionaryTest() {
            for (var i = 0; i < shortnsweetDict.Count; i++) {
                Assert.AreEqual(shortnsweetDict.ElementAt(i), readShortNSweet.BoardDict.ElementAt(i));
            }
        }
        ...
        public void TheBeachDictionaryTest() {
            for (var i = 0; i < thebeachDict.Count; i++) {
                Assert.AreEqual(thebeachDict.ElementAt(i), readTheBeach.BoardDict.ElementAt(i));
            }
        }
    }
}